...
class Transaction {
     ...
     * @throws \Exception
     */
    public function SetAndDoTransaction($model, $phone_number, $country_code) {
        try {
     ...
     * @throws \PayPhoneWebException
     */
    public function SetTransaction($model, $phone_number, $country_code) {
        try {
     ...
     * @throws \PayPhoneWebException
     */
    public function DoTransaction($id) {
        try {
     ...
     * @throws PayPhoneWebException
     */
    public function GetAnnulmentById($id) {
        try {
     ...
     * @throws PayPhoneWebException
     */
    public function DoReimbursement($id) {
        try {
     ...
     * @throws PayPhoneWebException
     */
    public function DoReimbursementByClientId($clientTransactionId) {
        try {
     ...
     * @throws PayPhoneWebException
     */
    public function DoAnnulment($model) {
        try {
    ...
    /**
     * Obtiene las monedas que son soportadas por la empresa asociada
